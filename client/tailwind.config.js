  ...
  theme: {
    extend: {
      ...
      keyframes: {
        ...
        glow: {
          '0%': { boxShadow: '0 0 5px rgba(92, 124, 250, 0.5), 0 0 20px rgba(92, 124, 250, 0.3)' },
          '100%': { boxShadow: '0 0 20px rgba(92, 124, 250, 0.8), 0 0 60px rgba(92, 124, 250, 0.4)' },
        },
        gradient: {
      ...
      boxShadow: {
        ...
        'glow-lg': '0 0 60px rgba(92, 124, 250, 0.4)',
        'inner-glow': 'inset 0 0 30px rgba(92, 124, 250, 0.1)',
      },
    },
  },
  plugins: [],
